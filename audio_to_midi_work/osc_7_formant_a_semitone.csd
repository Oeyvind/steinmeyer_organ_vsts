...
; in this example pitch is used for placement of formants (values used should produce the wowel "a" in a male bass0 voice)
  ...
  kwavekey1_semi = int(12 * log2(kwavekey1 / 440) + 69)
  kwavekey2_semi = int(12 * log2(kwavekey2 / 440) + 69)
  kwavekey3_semi = int(12 * log2(kwavekey3 / 440) + 69)
  kwavekey4_semi = int(12 * log2(kwavekey4 / 440) + 69)
  kwavekey1 = cpsmidinn(kwavekey1_semi)
  kwavekey2 = cpsmidinn(kwavekey2_semi)
  kwavekey3 = cpsmidinn(kwavekey3_semi)
  kwavekey4 = cpsmidinn(kwavekey4_semi)
...
a1,a2,a3,a4,a5,a6,a7,a8	partikkel agrainrate, kdistribution, idisttab, async, kenv2amt, ienv2tab, \
  ...
  a1 oscil 0.05, kwavekey1
  a2 oscil 0.05, kwavekey2
  a3 oscil 0.05, kwavekey3
  a4 oscil 0.05, kwavekey4
  afun oscil 0.5, p4
  asum sum a1,a2,a3,a4, afun
