...
nslider bounds(125,5,35,20), channel("duration_1"), range(0.0,1,0.5, 1, 0.001), fontSize(14)
...
label bounds(75, 25, 35, 10), text("notenum"), align("left")
nslider bounds(125,5,35,25), channel("duration_2"), range(0.0,1,0.5, 1, 0.001), fontSize(14)
label bounds(125, 25, 35, 10), text("duration"), align("left")
...
label bounds(75, 25, 35, 10), text("notenum"), align("left")
nslider bounds(125,5,35,25), channel("duration_3"), range(0.0,1,0.5, 1, 0.001), fontSize(14)
label bounds(125, 25, 35, 10), text("duration"), align("left")
...
label bounds(75, 25, 35, 10), text("notenum"), align("left")
nslider bounds(125,5,35,25), channel("duration_4"), range(0.0,1,0.5, 1, 0.001), fontSize(14)
label bounds(125, 25, 35, 10), text("duration"), align("left")
...
label bounds(75, 25, 35, 10), text("notenum"), align("left")
nslider bounds(125,5,35,25), channel("duration_5"), range(0.0,1,0.5, 1, 0.001), fontSize(14)
label bounds(125, 25, 35, 10), text("duration"), align("left")
...
instr 2
  ...
  Schan sprintf "channel_%i", ivoice
