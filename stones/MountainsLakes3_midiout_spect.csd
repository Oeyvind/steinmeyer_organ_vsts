...
nslider bounds(10, 89, 40, 20), channel("transpose_spect"), range(-48, 24, 0, 1, 1), fontSize(14)
...
nslider bounds(70, 89, 40, 20), channel("transpose_centroid"), range(-48, 24, 0, 1, 1), fontSize(14)
...
nslider bounds(130, 89, 40, 20), channel("transpose_mfcc"), range(-48, 24, 0, 1, 1), fontSize(14)
...
nslider bounds(190, 89, 40, 20), channel("transpose_zeroc"), range(-48, 24, 0, 1, 1), fontSize(14)
